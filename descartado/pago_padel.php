...
// Si alguien intenta entrar aquí directamente sin pasar por el formulario, lo echa a reserva_padel.php
if (!isset($_SESSION['reserva_fecha'])) {
    header("Location: reserva_padel.php");
    exit();
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="estilo/pago_padel.css">
...
<body>
    ...
    <section id="contenedor-pago">
        <div id="caja-pago">
            ...
            <a href="reserva_padel.php" id="btn-cancelar-pago">Cancelar y volver</a>
        </div>
    </section>
