    ...
    <section id="seccion-formulario">
        <div id="formulario-contenedor">
            ...
            <form action="procesar_reserva.php" method="POST">
                ...
                <div class="inputs">
                    <label for="numero_pista">Selecciona el campo</label>
                    <select id="numero_pista" name="numero_pista" required>
                        <option value="" disabled selected>Elige un campo</option>
                        <option value="1">Campo 1 (Fútbol 11 - Césped)</option>
                        <option value="2">Campo 2 (Fútbol 7 - Césped)</option>
                        <option value="3">Campo 3 (Fútbol 7 - Césped)</option>
                    </select>
                </div>
