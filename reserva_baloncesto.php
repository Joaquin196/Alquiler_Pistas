            ...
            <form action="procesar_reserva.php" method="POST">
                ...
                <div class="inputs">
                    ...
                    <select id="numero_pista" name="numero_pista" required>
                        ...
                        <option value="1">Pista 1 (Interior)</option>
                        <option value="2">Pista 2 (Interior)</option>
                        <option value="3">Pista 3 (Exterior)</option>
                        <option value="4">Pista 4 (Exterior)</option>
                    </select>
                </div>
